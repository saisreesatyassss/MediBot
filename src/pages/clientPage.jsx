...
import H1 from '../components/P1_comp/h1.jsx';
import H3 from '../components/P1_comp/h3.jsx';
import H4 from '../components/P1_comp/h4.jsx';
import H5 from '../components/P1_comp/h5.jsx';
import H6 from '../components/P1_comp/h6.jsx';
import H7 from '../components/P1_comp/h7.jsx';
...
export const ClientPage = () => {
  ...
  const handleClick=()=>{
    navigate(`/clientPage/profile/${state}`,{state:state});
  }

  const handleClickJobs=()=>{
    navigate(`/clientPage/jobs/${state}`,{state:state});
  }

  const handleClickHome=()=>{
    navigate(`/clientPage/${state}`,{state:state});
  }

  const handleClickAbout=()=>{
    navigate(`/clientPage/about/${state}`,{state:state})
  }
